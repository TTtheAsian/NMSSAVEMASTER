...
const playerState: PlayerState = {
  ...
  difficulty: {
    ...
    hazardDrain: 1.0,
    energyDrain: 1.0,
    substanceCollection: 1.0,
    chargingRequirements: 1.0,
    fuelUse: 1.0,
    launchFuelCost: 1.0,
    currencyCost: 1.0,
    scannerRecharge: 1.0,
    reputationGain: 1.0,
    creatureHostility: 1.0,
    spaceCombatTimers: 1.0,
    groundCombatTimers: 1.0,
    sprintingCost: 1.0,
    breakTechOnDamage: 0.1,
    inventoryStackLimits: 1,
    craftingIsFree: false,
    tutorialEnabled: true,
    startWithAllItemsKnown: false,
    baseAutoPower: false,
    inventoriesAlwaysInRange: false,
    allSlotsUnlocked: false,
    warpDriveRequirements: true,
    activeSurvivalBars: true,
  },
};
